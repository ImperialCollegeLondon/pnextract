...
{
	setDefaults(-5.0); 	//set _minRp to negative value if not provided by user, to be re-assigned in calc_distmaps(),  to be synced with setDefaults()
